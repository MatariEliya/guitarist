...
function Chords() {
    ...
    const [rawchords, setRawChords] = useState([
        { name: "C",  capo: 1, fingers: [{string:5,fret:1,barre:0,isExist:true},{string:3,fret:2,barre:0,isExist:true},{string:2,fret:3,barre:0,isExist:true},{isExist:false}], mute:1, difficult:0},
        { name: "C",  capo: 3, fingers: [{string:2,fret:1,barre:4,isExist:true},{string:3,fret:3,barre:0,isExist:true},{string:4,fret:3,barre:0,isExist:true},{string:5,fret:3,barre:0,isExist:true}], mute:1, difficult:0},
        { name: "C",  capo: 1, fingers: [{string:5,fret:1,barre:0,isExist:true},{string:3,fret:2,barre:0,isExist:true},{string:2,fret:3,barre:0,isExist:true},{string:6,fret:3,barre:0,isExist:true}], mute:1, difficult:0},
        { name: "G",  capo: 1, fingers: [{string:2,fret:2,barre:0,isExist:true},{string:1,fret:3,barre:0,isExist:true},{string:6,fret:3,barre:0,isExist:true},{isExist:false}], mute:0, difficult:0},
        { name: "D",  capo: 1, fingers: [{string:4,fret:2,barre:0,isExist:true},{string:6,fret:2,barre:0,isExist:true},{string:5,fret:3,barre:0,isExist:true},{isExist:false}], mute:3, difficult:0},
        { name: "Em", capo: 0, fingers: [{isExist:false},{string:2,fret:2,barre:0,isExist:true},{string:3,fret:2,barre:0,isExist:true},{isExist:false}], mute:0, difficult:0,},
        { name: "Am", capo: 1, fingers: [{string:5,fret:1,barre:0,isExist:true},{string:3,fret:2,barre:0,isExist:true},{string:4,fret:2,barre:0,isExist:true},{isExist:false}], mute:1, difficult:0},
        { name: "F",  capo: 1, fingers: [{string:1,fret:1,barre:5,isExist:true},{string:4,fret:2,barre:0,isExist:true},{string:2,fret:3,barre:0,isExist:true},{string:3,fret:3,barre:0,isExist:true}], mute:0, difficult:0 },
        { name: "Bm", capo: 1, fingers: [{string:2,fret:2,barre:4,isExist:true},{string:5,fret:3,barre:0,isExist:true},{string:3,fret:4,barre:0,isExist:true},{string:4,fret:4,barre:0,isExist:true}], mute:1, difficult:1},
        { name: "Gm", capo: 3, fingers: [{string:1,fret:1,barre:5,isExist:true},{isExist:false},{string:2,fret:3,barre:0,isExist:true},{string:3,fret:3,barre:0,isExist:true}], mute:0, difficult:1}
    ]);
    ...
    function sortChords(chords) {
        ...
        for(let i = 0; i < sortedChords.length; i++) {
            if (sortedChords[i].difficult <= difficultLevel) {
                        ...
                        {chord.length > 1 ? (
                            <Carousel className="carousel">
                                {chord.map((variant, variantIndex) => (
                                    <ChordDiagram key={variant.name + variantIndex} chord={variant}/>
                                ))}
                            </Carousel>
                        ) : (
...
export function ChordDiagram({chord, fontSize}) {
